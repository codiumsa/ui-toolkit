...
(function () {
  ...
  angular.module('ui').factory('timepickerState', function () {
    ...
    return {
      ...
      link: function link(scope, element, attrs) {
        console.log('link de la directiva timepicker');
        var picker = {
          open: function open() {
...
(function () {
  ...
  angular.module('ui').directive('uiDatatable', ['$timeout', '$uibModal', '$compile', '$state', '$resource', 'DTOptionsBuilder', 'DTColumnBuilder', 'baseurl', '$rootScope', function ($timeout, $modal, $compile, $state, $resource, DTOptionsBuilder, DTColumnBuilder, baseurl, $rootScope) {
...
(function () {
  ...
  angular.module('ui').factory('HttpInterceptor', function ($q, $location, $rootScope, $cookieStore, $injector) {
